...
angular.module('app').directive('appLogin', ['appConfig',
    function(appConfig) {
        return {
            restrict: 'A',
            scope: {
            ...
            template: function(element, attrs) {
                ...
                "<div class='center margin-tb'><span>Don't have an account with {{appTitle}}?</span> <a class='btn-link' ng-href='{{appPathLink}}register'>Sign Up</a></div>";
                return html;
            },
			...
			*/
                $scope.forgotPassDtv = function(params) {
                    ...
                    if ($scope.formVals.email !== undefined && $scope.formVals.email.length > 1) {
                        ...
                        $scope.$emit('evtAppalertAlert', {
                            type: 'error',
                            msg: 'Enter your email above to reset your password'
                        });
                    }
                };
