...
factory('appNav', ['$rootScope', 'jrgArray', 'appNavConfig', '$window',
	...
	*/
            updateNav: function(params) {
                ...
                if (params.pageToUse) {
                    ...
                    curPage = this.getPageFromRoute(params.urlInfo.page, {
                        queryParamsObj: params.urlInfo.queryParamsObj
                    });
                }
	...
	*/
            broadcastNavUpdates: function(params) {
                $rootScope.$broadcast('appNavHeaderUpdate', {
                    nav: this.curNav
                }); //update header
                $rootScope.$broadcast('appNavFooterUpdate', {
                    nav: this.curNav
                }); //update footer
