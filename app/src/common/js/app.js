...
config(['$routeProvider', '$locationProvider', 'appConfigProvider', '$compileProvider',
    function($routeProvider, $locationProvider, appConfigProvider, $compileProvider) {
        /**
	...
	*/
        ...
        $routeProvider.when(appPathRoute + 'logout', {
            templateUrl: pagesPath + 'logout/logout.html',
            resolve: {
                auth: function(appAuth) {
                    return appAuth.checkSess({});
                }
        ...
        $routeProvider.when(appPathRoute + 'user-delete', {
        ...
        $routeProvider.when(appPathRoute + 'callback-twitter-auth', {
            templateUrl: pagesPath + 'callback/callback-twitter-auth/callback-twitter-auth.html',
            resolve: {
                auth: function(appAuth) {
                    return appAuth.checkSess({});
                }
        ...
        $routeProvider.when(appPathRoute + 'callback-facebook-auth', {
            templateUrl: pagesPath + 'callback/callback-facebook-auth/callback-facebook-auth.html',
            resolve: {
                auth: function(appAuth) {
                    return appAuth.checkSess({});
                }
        ...
        //d4d - Site
        // $routeProvide.when(appPathRoute+'home', {templateUrl: pagesPath+'home'});
        $routeProvider.when(appPathRoute + '', {
        ...
        $routeProvider.when(appPathRoute + 'dev-test/socketio', {
            templateUrl: pagesPath + 'dev-test/socketio/socketio.html',
            resolve: {
                auth: function(appAuth) {
                    return appAuth.checkSess({});
                }
