...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			"modules/pages/pricing/PricingCtrl.js",
			"modules/pages/dialpad/DialpadCtrl.js",
			...
			"modules/pages/pricing/PricingCtrl.spec.js",
			"modules/pages/dialpad/DialpadCtrl.spec.js",
		...
		preprocessors: {
			...
			"modules/pages/pricing/PricingCtrl.js":["coverage"],
			"modules/pages/dialpad/DialpadCtrl.js":["coverage"],
