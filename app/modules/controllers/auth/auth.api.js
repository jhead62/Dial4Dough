    ...
    return {
		...
		**/
        action: function(params, out) {
            ...
            promise.then(
                function(ret1) {
                    ret1.user = UserMod.readFilter(ret1.user, {
                        type: 'login'
                    }); //only return certain fields (i.e strip out password)
    ...
    return {
        ...
        params: {
            ...
            user_id: {
                required: true,
                type: 'string',
                info: "Id of user to check session for"
            },
            sess_id: {
                required: true,
                type: 'string',
                info: "Id of user session"
            }
            // }
        },
        returns: {
    ...
    return {
        ...
        params: {
            ...
            email: {
                required: true,
                type: 'string',
                info: "Email of user requesting a reset"
            }
            // }
        },
        returns: {
    ...
    return {
        ...
        params: {
            user_id: {
                required: true,
                type: 'string',
                info: "Identify user to change password for"
            },
            current_password: {
                required: true,
                type: 'string',
                info: "The user's current password (to authenticate)"
            },
            new_password: {
                required: true,
                type: 'string',
                info: "New password to set"
            }
        },
        returns: {
            user: sampleUserReturn
    ...
    return {
        ...
        params: {
            users: {
                required: true,
                type: 'array',
                info: "Array of new user objects. Each object must contain an email, phone, or _id field. May contain other user information."
            },
            user_id: {
                required: false,
                type: 'string',
                info: "Id of user who is importing. This is used to link/follow these new users."
            },
            follow: {
                required: false,
                type: 'number',
                info: "1 to have the user_id user follow all the users after being imported."
            }
        },
        returns: {
    ...
    return {
        ...
        params: {
            user: {
                required: true,
                type: 'object',
                info: "User object. Must contain an email, phone, or _id field. May contain other user information."
            },
            socialData: {
                required: true,
                type: 'object',
                info: "The social data to save - typically a 'token' and 'id'."
            },
            type: {
                required: true,
                type: 'string',
                info: "A key to save the token under, describing the social site. Ex: 'facebook', 'google', etc."
            }
        },
        returns: {
